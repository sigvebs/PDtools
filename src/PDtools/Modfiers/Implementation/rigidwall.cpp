...
{
//------------------------------------------------------------------------------
RigidWall::RigidWall(Grid &grid, int orientationAxis, int topOrBottom, double lc):
    m_grid(grid),
    m_orientationAxis(orientationAxis),
    ...
    m_lc(lc)
{
    ...
    case 2:
        ...
        break;
    default:
        cerr << "Rigid Wall:: orientation:" << m_orientationAxis
             << " is not valid" << endl;
        exit(EXIT_FAILURE);
    }
