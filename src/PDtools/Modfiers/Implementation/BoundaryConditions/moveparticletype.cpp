...
namespace PDtools {
//------------------------------------------------------------------------------
MoveParticleGroup::MoveParticleGroup(int groupId, double velAmplitude,
                                     vec velocityDirection, double dt,
                                     bool isStatic)
    : m_groupId(groupId), m_velAmplitude(velAmplitude), m_dt(dt),
      m_isStatic(isStatic), m_time(dt),
