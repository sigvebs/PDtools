...
{
//------------------------------------------------------------------------------
MohrCoulombBondFracture::MohrCoulombBondFracture(double mu, double C, double T, int dim):
...
//            const double s = sin(theta);
            ...
            if(s_n >= m_T)
            {
                ...
                cout << id_i << " > " << id_j << " " << endl
                     ...
                     << s1 << "\t" << 0.5*(s1 + s2) << "\t:" << theta_p*180/M_PI << endl;
                }
            }
            else if(s_n < 0)
            {
...
//                    cout << "sx:" << sx << " sy:" << sy << " sxy:" << sxy  << endl;
            ...
            //            if(id_i == 1087)
            //            {
            //                cout << "(" << id_j << ") " << sx_i << " "<< sx_j << " t:" << theta_i*180/M_PI << " ";
            //            }

            //            if(sxy > fabs(-m_C + m_d*s_compressive))
            //            {
            //                con.second[m_indexConnected] = 0;
            //                cout << id_i << " -> (" << id_j << ") " << sx << " "<< sy << " t:" << theta_i*180/M_PI << endl;
            //                cout << "sx_i:" << data(i, m_indexStress[0]) << " sx_j:" << data(j, m_indexStress[0]) << endl;
            //                cout << "sy_i:" << data(i, m_indexStress[1]) << " sy_j:" << data(j, m_indexStress[1]) << endl;
            //            }
        }
//        if(id_i == 1087)
//        {
