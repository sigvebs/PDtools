...
{
//------------------------------------------------------------------------------
MohrCoulombMaxFractureWeighted::MohrCoulombMaxFractureWeighted(double mu,
                                                               double C,
                                                               double T,
                                                               double Wc,
                                                               double Bc):
...
//------------------------------------------------------------------------------
void MohrCoulombMaxFractureWeighted::evaluateStepOne(const int id_i, const int i)
{
    mat & data = *m_data;
...
//------------------------------------------------------------------------------
//void MohrCoulombMaxFractureWeighted::evaluateStepOne(const int id_i, const int i)
void MohrCoulombMaxFractureWeighted::evaluateStepTwo(const int id_i, const int i)
{
