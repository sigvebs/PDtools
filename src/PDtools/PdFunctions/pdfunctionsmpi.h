...
void
exchangeGhostParticles_boundary(Grid &grid, PD_Particles &particles);

void
exchangeInitialGhostParticles(Grid &grid, PD_Particles &particles);

void
exchangeInitialGhostParticles_boundary(Grid &grid, PD_Particles &particles);
...
void
exchangeInitialPeriodicBoundaryParticlesInitial(Grid &grid, PD_Particles &particles, bool sendPDdata);

void
exchangePeriodicBoundaryParticlesInitial(Grid &grid, PD_Particles &particles, bool sendPDdata);
}
//------------------------------------------------------------------------------
