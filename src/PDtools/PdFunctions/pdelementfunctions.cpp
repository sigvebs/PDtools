...
{
//------------------------------------------------------------------------------
void setPdElementConnections(PD_Particles & discretization,
                             Grid & grid,
                             const double delta)
{
...
//                    bool intersects_ij = bg::intersects(interactionPolygon_i, polygon_j);
...
//                            continue;
                ...
                cout << double(intersectingPolygons)/double(totoalNumberPolygons) << "\t " << tot_area/A0 << endl;
                cout << "----------------" << endl;
                //                    bool intersects_ij = bg::intersects(interactionPolygon_i, polygon_j);
                //                    if (!intersects_ij)
                //                        continue;
