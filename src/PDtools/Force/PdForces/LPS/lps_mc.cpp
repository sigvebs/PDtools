...
namespace PDtools {
//------------------------------------------------------------------------------
LPS_mc::LPS_mc(PD_Particles &particles, double c, double phi, double C,
               double T, bool planeStress, bool analyticalM)
    : PD_LPS(particles, planeStress, analyticalM), m_dampCoeff(c), m_T(T) {
...
//------------------------------------------------------------------------------
void LPS_mc::initialize(double E, double nu, double delta, int dim, double h,
                        double lc) {
