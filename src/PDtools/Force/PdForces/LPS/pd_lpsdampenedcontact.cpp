...
namespace PDtools {
//------------------------------------------------------------------------------
PD_lpsDampenedContact::PD_lpsDampenedContact(PD_Particles &particles, double c,
                                             bool planeStress)
    : PD_LPS(particles, planeStress), m_dampCoeff(c) {
...
//------------------------------------------------------------------------------
double PD_lpsDampenedContact::calculatePotentialEnergyDensity(const int id_i,
                                                              const int i) {
