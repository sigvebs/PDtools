...
{
//------------------------------------------------------------------------------
PD_LPS_adrmc::PD_LPS_adrmc(PD_Particles &particles, double phi, double C, double T, bool planeStress, bool analyticalM):
    LPS_mc(particles, 0., phi, C, T, planeStress, analyticalM)
{
