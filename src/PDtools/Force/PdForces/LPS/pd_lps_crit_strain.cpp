...
namespace PDtools {
//------------------------------------------------------------------------------
PD_LPS_CRIT_STRAIN::PD_LPS_CRIT_STRAIN(PD_Particles &particles, double c,
                                       double stretchCrit, double shearCrit,
                                       bool planeStress, bool analyticalM)
    : PD_LPS(particles, planeStress, analyticalM), m_stretchCrit(stretchCrit),
      m_shearCrit(shearCrit), m_dampCoeff(c) {
