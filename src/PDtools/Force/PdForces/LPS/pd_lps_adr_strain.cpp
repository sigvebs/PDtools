...
{
//------------------------------------------------------------------------------
PD_LPS_ADR_STRAIN::PD_LPS_ADR_STRAIN(PD_Particles &particles, double c, double stretchCrit, double shearCrit, bool planeStress, bool analyticalM):
    PD_LPS_CRIT_STRAIN(particles, c, stretchCrit, shearCrit, planeStress, analyticalM)
{
