...
namespace PDtools {
//------------------------------------------------------------------------------
class LPS_porosity_mc : public PD_LPS_POROSITY {
public:
  LPS_porosity_mc(PD_Particles &particles, double m, double b, double c,
                  double phi, double C, double T, bool planeStress = false,
  ...
  void updateWeightedMass(int id, int i);
