...
{
//------------------------------------------------------------------------------
LPS_porosity_mc::LPS_porosity_mc(PD_Particles &particles,  double m, double b, double c, double phi, double C, double T, bool planeStress, bool analyticalM):
...
//------------------------------------------------------------------------------
void LPS_porosity_mc::initialize(double E, double nu, double delta, int dim, double h, double lc)
{
...
//------------------------------------------------------------------------------
void LPS_porosity_mc::computeStress(const int id, const int i, const int nConnected)
{
    //--------------------------------------------------------------------------
    // Stress
    //--------------------------------------------------------------------------
