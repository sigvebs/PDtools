...
{
//------------------------------------------------------------------------------
PD_LPS_POROSITY::PD_LPS_POROSITY(PD_Particles &particles, double phi_c, double n, bool planeStress, bool analyticalM):
    Force(particles),
...
//------------------------------------------------------------------------------
double PD_LPS_POROSITY::calculatePotentialEnergyDensity(const int id_i, const int i)
{
    ...
    for(int l_j=0; l_j<nConnections; l_j++) {
        ...
        const double dr = sqrt(dr2);
        const double ds = dr - dr0;
        const double extension_term =  a_i*w*(pow(ds - theta_i*dr0/m_dim, 2));
...
//------------------------------------------------------------------------------
void PD_LPS_POROSITY::calculatePotentialEnergy(const int id_i, const int i, int indexPotential)
{
...
//------------------------------------------------------------------------------
double PD_LPS_POROSITY::calculateStableMass(const int id_a, const int a, double dt)
{
    dt *= 1.1;
...
//------------------------------------------------------------------------------
void PD_LPS_POROSITY::initialize(double E, double nu, double delta, int dim, double h, double lc)
{
...
//------------------------------------------------------------------------------
void PD_LPS_POROSITY::calculateStress(const int id_i, const int i, const int (&indexStress)[6])
{
