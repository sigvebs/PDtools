...
//------------------------------------------------------------------------------
void PD_LPSS::calculatePotentialEnergy(const int id_i, const int i, int indexPotential)
{
...
//------------------------------------------------------------------------------
void PD_LPSS::evaluateStepOne(const int id_i, const int i)
{
    (void) id_i;
}
//------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------
void PD_LPSS::initialize(double E, double nu, double delta, int dim, double h, double lc)
{
