...
void PD_LPSS_G::calculateForces(const int id_i, const int i)
{
    ...
    if(m_dim == 3) {
        ...
        for(int l_j=0; l_j<nConnections; l_j++) {
            ...
            const double e_i =(dud_ij[0]*dud_ij[0] + dud_ij[1]*dud_ij[1] + dud_ij[2]*dud_ij[2]);
            const double e_j =(dud_ji[0]*dud_ji[0] + dud_ji[1]*dud_ji[1] + dud_ji[2]*dud_ji[2]);
...
//------------------------------------------------------------------------------
void PD_LPSS_G::initialize(double E, double nu, double delta, int dim, double h, double lc)
{
