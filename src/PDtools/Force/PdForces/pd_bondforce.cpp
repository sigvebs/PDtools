...
//------------------------------------------------------------------------------
double PD_bondForce::calculatePotentialEnergyDensity(const int id_i,
                                                     const int i) {
  const double c_i = m_data(i, m_indexMicromodulus);
  double dr_ij[m_dim];
...
//------------------------------------------------------------------------------
void PD_bondForce::calculatePotentialEnergy(const int id_i, const int i,
                                            int indexPotential) {
  const double vol_i = m_data(i, m_indexVolume);
  m_data(i, indexPotential) += calculatePotentialEnergyDensity(id_i, i) * vol_i;
}
//------------------------------------------------------------------------------
void PD_bondForce::calculateStress(const int id_i, const int i,
...
//------------------------------------------------------------------------------
double PD_bondForce::calculateStableMass(const int id_a, const int a,
                                         double dt) {
  dt *= 1.1;
...
//------------------------------------------------------------------------------
void PD_bondForce::initialize(double E, double nu, double delta, int dim,
                              double h, double lc) {
