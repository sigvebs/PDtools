...
//------------------------------------------------------------------------------
void EPD_LPS::calculatePotentialEnergy(const int id_i, const int i,
                                       int indexPotential) {
...
//------------------------------------------------------------------------------
void EPD_LPS::initialize(double E, double nu, double delta, int dim, double h,
                         double lc) {
...
//------------------------------------------------------------------------------
void EPD_LPS::calculateStress(const int id_i, const int i,
