...
//    double weightFunction(const double dr0) const {return exp(-2.*dr0/m_delta);}
    //       double weightFunction(const double dr0) const {return 1./(dr0*dr0);}
    //           double weightFunction(const double dr0) const {return (1. - 1.01*dr0*dr0/(m_delta*m_delta));}
