...
protected:
  ...
  const double x2[2] = {0.5773502691896257645091488,
                        -0.5773502691896257645091488};
  const double w2[2] = {1.0000000000000000000000000,
                        1.0000000000000000000000000};

  const double x3[3] = {0.0000000000000000000000000,
                        0.7745966692414833770358531,
                        -0.7745966692414833770358531};
  const double w3[3] = {0.8888888888888888888888889,
  ...
  const double x5[5] = {
      0.0000000000000000000000000, 0.5384693101056830910363144,
      0.9061798459386639927976269, -0.5384693101056830910363144,
...
protected:
  ...
  const double x4[6] = {0.44594849091597, 0.44594849091597, 0.10810301816807,
                        0.09157621350977, 0.09157621350977, 0.81684757298046};
  const double y4[6] = {0.44594849091597, 0.10810301816807, 0.44594849091597,
                        0.09157621350977, 0.81684757298046, 0.09157621350977};
  const double w4[6] = {0.22338158967801, 0.22338158967801, 0.22338158967801,
                        0.10995174365532, 0.10995174365532, 0.10995174365532};

  const double x5[7] = {0.33333333333333, 0.47014206410511, 0.47014206410511,
                        0.05971587178977, 0.10128650732346, 0.10128650732346,
                        0.79742698535309};
  const double y5[7] = {0.33333333333333, 0.47014206410511, 0.05971587178977,
                        0.47014206410511, 0.10128650732346, 0.79742698535309,
                        0.10128650732346};
  const double w5[7] = {0.22500000000000, 0.13239415278851, 0.13239415278851,
