...
namespace PDtools {
//------------------------------------------------------------------------------
int Particles::verletUpdateFreq() const { return m_verletUpdateFreq; }
//------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------
const vector<int> &Particles::ghostParameters() { return m_ghostParameters; }
//------------------------------------------------------------------------------
const vector<string> &Particles::ghostParametersString() {
  return m_ghostParametersString;
}
//------------------------------------------------------------------------------
int Particles::newId() { return m_newId++; }
//------------------------------------------------------------------------------
int Particles::needGhostVelocity() const { return m_needGhostVelocity; }
//------------------------------------------------------------------------------
void Particles::setNeedGhostVelocity(int needGhostVelocity) {
  m_needGhostVelocity = needGhostVelocity;
}
//------------------------------------------------------------------------------
int Particles::getNeedGhostR0() const { return m_needGhostR0; }
//------------------------------------------------------------------------------
...
void Particles::initializeMatrices() {
  if (m_nParticles == 0) {
    cerr << "nParticles can not be zero when initializeing particle matrices"
         << endl;
    throw ZeroParticles;
  }
...
//------------------------------------------------------------------------------
void Particles::type(string t) { m_type = t; }
//------------------------------------------------------------------------------
unsigned int Particles::nParticles() const { return m_nParticles; }
//------------------------------------------------------------------------------
void Particles::nParticles(int nP) { m_nParticles = nP; }
//------------------------------------------------------------------------------
void Particles::dim(int d) { m_dim = d; }
//------------------------------------------------------------------------------
int Particles::nGhostParticles() { return m_nGhostParticles; }
//------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------
unordered_map<string, int> &Particles::parameters() { return m_parameters; }
//------------------------------------------------------------------------------
int Particles::parameters(const string &id) { return m_parameters.at(id); }
//------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------
int Particles::getVerletSize() const { return m_verletListIds.size(); }
//------------------------------------------------------------------------------
