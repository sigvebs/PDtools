...
protected:
  ...
  virtual unordered_map<string, int> read_xyzHeader(std::fstream &data);
  virtual unordered_map<string, int> read_lmpHeader(std::fstream &data);
  ...
  virtual void loadBody(Particles &particles, std::fstream &data,
                        unordered_map<string, int> parameters);
  virtual void loadBinaryBody(Particles &particles, FILE *data,
                              unordered_map<string, int> parameters);
...
public:
  ...
  Particles load(string loadPath, string format, bool bin = false,
                 unordered_map<string, int> loadParameters = {{}});
  void setGrid(Grid &grid) { m_grid = &grid; }
  void useLegacyFormat(bool ulf) { m_useLegacyFormat = ulf; }
};
...
// 2	0.731905	0.547958	0.212907	0.112907
// 8.0501e-06
// 3	0.650592	0.343276	0.529744	0.329744
// 8.31843e-06
// 4	0.109496	0.449608	0.195344	0.695344
// 7.78176e-06
// 5	0.532164	0.704623	0.504753	0.0504753
// 6.44008e-06
// 6	0.685139	0.468903	0.236449	0.536449
// 7.33453e-06
// 7	0.678746	0.390759	0.546610	0.346610
// 8.0501e-06
// 8	0.384222	0.581632	0.681405	0.168145
// 8.31843e-06
// 9	0.947418	0.401296	0.665064	0.166564
// 7.0662e-06
// 10	0.294880	0.368566	0.110014	0.111014
// 8.13954e-06
